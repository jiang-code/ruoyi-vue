...
import com.ruoyi.dts.db.mapper.DtsCouponMapper;
import com.ruoyi.dts.db.mapper.DtsCouponUserMapper;
import com.ruoyi.dts.db.domain.DtsCoupon;
import com.ruoyi.dts.db.domain.DtsCoupon.Column;
import com.ruoyi.dts.db.domain.DtsCouponExample;
...
public class DtsCouponService {
	...
	public List<DtsCoupon> querySelective(String name, Short type, Short status) {
		DtsCouponExample example = new DtsCouponExample();
