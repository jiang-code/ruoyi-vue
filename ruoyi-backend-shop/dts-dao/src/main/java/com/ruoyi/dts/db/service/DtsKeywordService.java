...
import com.ruoyi.dts.db.mapper.DtsKeywordMapper;
import com.ruoyi.dts.db.domain.DtsKeyword;
import com.ruoyi.dts.db.domain.DtsKeywordExample;
...
public class DtsKeywordService {
	...
	public List<DtsKeyword> querySelective(String keyword, String url) {
		DtsKeywordExample example = new DtsKeywordExample();
