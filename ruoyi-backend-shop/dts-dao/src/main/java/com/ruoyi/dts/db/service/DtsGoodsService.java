...
import com.ruoyi.dts.db.domain.DtsGoodsExample;
...
public class DtsGoodsService {
    DtsGoods.Column[] columns = new DtsGoods.Column[]{DtsGoods.Column.id, DtsGoods.Column.name, DtsGoods.Column.brief
			, DtsGoods.Column.picUrl, DtsGoods.Column.isHot, DtsGoods.Column.isNew,
    ...
    public List<DtsGoods> querySelective(String goodsSn, String name, List<Integer> brandIds) {
        DtsGoodsExample example = new DtsGoodsExample();
