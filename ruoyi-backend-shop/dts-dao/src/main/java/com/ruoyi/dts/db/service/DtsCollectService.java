...
import com.ruoyi.dts.db.mapper.DtsCollectMapper;
import com.ruoyi.dts.db.domain.DtsCollect;
import com.ruoyi.dts.db.domain.DtsCollectExample;
...
public class DtsCollectService {
	...
	public List<DtsCollect> querySelective(String userId, String valueId) {
		DtsCollectExample example = new DtsCollectExample();
