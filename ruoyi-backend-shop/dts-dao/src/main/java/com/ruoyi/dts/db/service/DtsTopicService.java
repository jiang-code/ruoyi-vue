...
import com.ruoyi.dts.db.mapper.DtsTopicMapper;
import com.ruoyi.dts.db.domain.DtsTopic;
import com.ruoyi.dts.db.domain.DtsTopicExample;
...
public class DtsTopicService {
	...
	private DtsTopic.Column[] columns = new DtsTopic.Column[] { DtsTopic.Column.id, DtsTopic.Column.title, DtsTopic.Column.subtitle, DtsTopic.Column.price, DtsTopic.Column.picUrl,
	...
	public List<DtsTopic> querySelective(String title, String subtitle) {
		DtsTopicExample example = new DtsTopicExample();
