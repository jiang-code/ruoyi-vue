...
import com.ruoyi.dts.db.mapper.DtsOrderMapper;
import com.ruoyi.dts.db.mapper.ex.OrderMapper;
import com.ruoyi.dts.db.mapper.ex.StatMapper;
import com.ruoyi.dts.db.domain.DtsOrder;
import com.ruoyi.dts.db.domain.DtsOrderExample;
...
public class DtsOrderService {
	...
	public List<DtsOrder> querySelective(Integer userId, String orderSn, List<Short> orderStatusArray) {
		DtsOrderExample example = new DtsOrderExample();
