package com.ruoyi.dts.core.system;
...
import com.ruoyi.dts.core.util.SystemInfoPrinter;
...
class SystemInistService {
	...
	private Map<String, String> getSystemInfo() {
		...
		infos.put("调试级别", environment.getProperty("logging.level.com.ruoyi.dts.wx"));
